...
@Slf4j
@ControllerAdvice //Bu anotasyon, global hata yakalama için kullanılır ve bu sınıfın bir global exception handler olduğunu belirtir. Uygulamadaki tüm controller'lar için geçerlidir.
