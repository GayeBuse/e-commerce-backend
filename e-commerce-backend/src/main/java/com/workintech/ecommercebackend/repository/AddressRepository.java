...
// Bu, her bir entity sınıfının veritabanı işlemlerini yönetmek için bir repository sınıfına sahip olması anlamına gelir. Bu yaklaşım, veri erişim katmanının modüler ve yönetilebilir olmasını sağlar
